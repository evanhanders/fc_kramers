...
try:
    ...
    from atmospheres import KramerPolytrope, Polytrope
except:
    from sys import path
    path.insert(0, './stratified_dynamics')
    from stratified_dynamics.equations import *
    from stratified_dynamics.atmospheres import KramerPolytrope, Polytrope


class FC_polytrope_2d_kramers(FC_equations_2d_kramers, KramerPolytrope):
    def __init__(self, dimensions=2, *args, max_ncc_bandwidth=None, fully_nonlinear=False, **kwargs):
